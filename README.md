...
```bash
curl -fsSL "https://raw.githubusercontent.com/BavariaByte/PRXDash/main/create-cloud-init-template.sh" | sudo bash -s -- -s local-lvm -d ubuntu24
```
...
```bash
curl -fsSL "https://raw.githubusercontent.com/BavariaByte/PRXDash/main/create-cloud-init-template.sh" | sudo bash -s -- -s local-zfs -d ubuntu24
```

Debian 12 mit custom VMID:

```bash
curl -fsSL "https://raw.githubusercontent.com/BavariaByte/PRXDash/main/create-cloud-init-template.sh" | sudo bash -s -- -i 9001 -s local-lvm -d debian12
```
...
```text
https://raw.githubusercontent.com/<ORG>/<REPO>/refs/heads/main/<script>.sh
```
